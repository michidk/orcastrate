...
fn build_pr_body(update: &WorkflowUpdate) -> String {
    ...
    body.push_str(
        "This PR was automatically generated by [orcastrate 🐬](https://github.com/michidk/orcastrate) \
    ...
    body.push_str("---\n*Managed by [orcastrate 🐬](https://github.com/michidk/orcastrate). Do not edit managed sections manually.*\n");
